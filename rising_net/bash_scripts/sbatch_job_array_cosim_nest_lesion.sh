...
#SBATCH --output=./outputs/COSIM_NEST_LESIONnorm/logs/CosNESTles_%A_%a.out
#SBATCH --error=./outputs/COSIM_NEST_LESIONnorm/errors/CosNESTles_%A_%a.err
#SBATCH --array=0-9  # 69  # 0-79
