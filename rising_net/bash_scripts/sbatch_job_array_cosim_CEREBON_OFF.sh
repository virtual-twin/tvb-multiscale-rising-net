...
#SBATCH --job-name=Cosim
#SBATCH --output=./outputs/COSIM_CEREBON_OFF/logs/Cosim_%A_%a.out
#SBATCH --error=./outputs/COSIM_CEREBON_OFF/errors/Cosim_%A_%a.err
#SBATCH --array=0-29  # 59  # 99
