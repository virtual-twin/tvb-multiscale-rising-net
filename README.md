...
```
cd existing_repo
git remote add origin https://git.bihealth.org/rising_net/tvb-multiscale-rising_net.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.bihealth.org/rising_net/tvb-multiscale-rising_net/-/settings/integrations)
