...
#SBATCH --job-name=TVB
#SBATCH --output=./outputs/TVB_CEREBON_OFF/logs/TVB_%A_%a.out
#SBATCH --error=./outputs/TVB_CEREBON_OFF/errors/TVB_%A_%a.err
#SBATCH --array=0-99
...
CMD="bash ${CMD_PATH}simulate_tvb_CEREBON_OFF_jobarr.sh ${JOB_ID}"
