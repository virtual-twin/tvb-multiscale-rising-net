...
#SBATCH --job-name=FTmnRN4
#SBATCH --output=./outputs/FIT_TASKn4/mean_sims/allruns/logs/FIT_TASK_MEAN_%A_%a.out
#SBATCH --error=./outputs/FIT_TASKn4/mean_sims/allruns/errors/FIT_TASK_MEAN_%A_%a.err
#SBATCH --array=4-8
