...
#SBATCH --job-name=FIT_REST_PPC3
#SBATCH --output=./outputs/FIT_REST/PPC_sims/logs/FIT_REST_PPC3_%A_%a.out
#SBATCH --error=./outputs/FIT_REST/PPC_sims/errors/FIT_REST_PPC3_%A_%a.err
#SBATCH --array=0-5499
#SBATCH --time=30:00
