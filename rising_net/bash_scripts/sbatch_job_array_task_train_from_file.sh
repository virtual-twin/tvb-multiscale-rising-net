...
#SBATCH --job-name=FTtrainN4
#SBATCH --output=./outputs/FIT_TASKn4/logs/FIT_TASK_%A_%a.out
#SBATCH --error=./outputs/FIT_TASKn4/errors/FIT_TASK_%A_%a.err
#SBATCH --array=1-214
...
CMD="bash ${CMD_PATH}simulate_task_train_jobarr_from_file.sh ${JOB_ID}"
